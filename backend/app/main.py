...
def query(
    ...
    with logfire.span("🔍 /query", request_id=request_id, thread_id=thread_id):
        ...
        if rail_fired:
            ...
            logfire.info("🛡️ Security Firewall / Guardrail Intercepted Request", request_id=request_id, thread_id=thread_id)
            return {
                "question": q,
                "answer": rail_response,
                "thought_process": ["Perimeter Shield: Triggered", "Retrieval: Skipped"],
                "status": "Handled at Perimeter Shield.",
                "sources": [],
            }
