...
def _build_judge():
    ...
    from app.gateway.client import PORTKEY_GATEWAY_URL, _make_headers
    ...
    if settings.OPENAI_API_KEY:
        ...
        # Route LLM judge evaluations through Portkey Gateway + Groq load balancer
        client = AsyncOpenAI(
            api_key=settings.PORTKEY_API_KEY,
            base_url=PORTKEY_GATEWAY_URL,
            default_headers=_make_headers("evals_judge"),
        )
